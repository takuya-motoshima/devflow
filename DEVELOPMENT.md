...
**リポジトリ**: [takuya-motoshima/devflow](https://github.com/takuya-motoshima/devflow)
...
```
devflow/                             # プラグインリポジトリ（ルート直下に .claude-plugin/）
├── .claude-plugin/
...
4. `claude --plugin-dir .` でローカルテスト（下記チェックリスト参照）
